...
foreach (var group in operePerArtista)
{
    ...
    //vogliamo conoscere i dettagli dell'artista di cui conosciamo l'id
...
var opereDiArtistaGroupBy = artisti
    .Join(opere,
        a => a.Id,
        o => o.FkArtista,
        (a, o) => new { a, o })
...
var opereDiArtistaGroupByMultiplo = artisti
    .Join(opere,
        ...
        o => o.FkArtista,
        (a, o) => new { a, o })
    .GroupBy(t => new { t.a.Nazionalita, t.a.Cognome });
...
//7)Trovare gli artisti di cui sono presenti almeno 2 opere
Console.WriteLine("\n**** 7) Trovare gli artisti di cui sono presenti almeno 2 opere\n");
//calcoliamo gli artisti di cui abbiamo almeno un'opera
var artistiConAlmeno1Opera = artisti
    .Join(opere,
        a => a.Id,
        o => o.FkArtista,
        (a, o) => a);
//per calcolare gli artisti di cui sono presenti almeno due opere procediamo così:
//raggruppiamo gli artisti per FkArtista e successivamente filtriamo in base al conteggio degli 
//elementi in ogni gruppo
Console.WriteLine("Artisti con almeno due opere");
var artistiConAlmeno2Opere = opere
    .GroupBy(o => o.FkArtista)
    .Where(g => g.Count() >= 2)
    .Join(artisti,
        g => g.Key,
        a => a.Id,
...
//altra variante - riportiamo gli artisti con il relativo numero di opere
opere
    .GroupBy(o => o.FkArtista)
...
var opereConMaxNumeroPersonaggi = personaggiPerOpera
    ...
    .Join(opere,
        t => t.IdOpera,
        o => o.Id,
        (t, o) => new { id = o.Id, o.Titolo, Personaggi = t.NumeroPersonaggi });
